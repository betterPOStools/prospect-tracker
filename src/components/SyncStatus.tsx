...
export default function SyncStatus() {
  ...
  if (!isOnline) {
    return (
      <div className="flex shrink-0 items-center gap-1 text-[10px] font-medium text-red-600">
  ...
  if (queueLength > 0) {
    return (
      <div className="flex shrink-0 items-center gap-1 text-[10px] font-medium text-yellow-600">
  ...
  return (
    <div className="flex shrink-0 items-center gap-1 text-[10px] font-medium text-gray-400">
